/**
* @project_name pragith md 
* @authors Prabath Kumara & sachibot-team(Sachintha) <https://github.com/Xsasidu>
* @description The main hope of creating this bot is to take full advantage of the WhatsApp app and make its work easier
* @link <https://github.com/Xsasidu/pragith md>
* @version 2.0.6

© 2023 , pragith md. All rights reserved.
